...
!     REG%alpha  = 14.5d0
    ...
    call map_init(mCCSM3_REG,gCCSM3,gREG,max_neighbors=10,lat_lim=4.0d0,dist_max=500d0,fldr="maps",load=.TRUE.)
    call map_init(mREG_CCSM3,gREG,gCCSM3,max_neighbors=30,lat_lim=2.0d0,dist_max=1d6,fldr="maps",load=.FALSE.)
