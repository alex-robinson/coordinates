...
program test_MAR
    ...
    file_output    = "/Users/robinson/wrk_local/data/MAR/ICE.1979-2006_sicogrid.nc"
    ...
    call grid_init(gSICO,name="SICO-20KM",mtype="polar stereographic",units="kilometers",lon180=.TRUE., &
    ...
    do t = 1, ttot 
        ...
        call nc_read(file_input,var_in,var_name,start=(/1,1,1,t/),count=(/gMAR%G%nx,gMAR%G%ny,1,1/))
        ...
        call nc_write(file_output,var_out,  var_name,  dim1="xc",dim2="yc",dim3="time", &
