...
ifeq ($(ifort),1)
	## IFORT OPTIONS ##
	FFLAGS   = -heap-arrays -module $(objdir) -L$(objdir) $(INC_NC) 
	LFLAGS	 = $(LIB_NC) 
	SFLAGS   = 
	...
	## GFORTRAN OPTIONS ##
	FFLAGS   = -I$(objdir) -J$(objdir) $(INC_NC)
	LFLAGS	 = $(LIB_NC)
	SFLAGS   = 
...
coord-shared: $(coord_libs) $(objdir)/coord.o $(coord_obj)
	$(FC) $(DFLAGS) $(FFLAGS) -shared -fPIC -o libcoordinates.so $(objdir)/coord.o $(coord_obj) $(LFLAGS)
	@echo " "
...
coord0-shared: $(coord_libs) $(objdir)/coord.o $(coord0_obj)
	$(FC) $(DFLAGS) $(FFLAGS) -shared -fPIC -o libcoordinates0.so $(objdir)/coord.o $(coord0_obj) $(LFLAGS)
	@echo " "
...
test_ccsm3: coord-static
	$(FC) $(DFLAGS) $(FFLAGS) -o test_ccsm3.x $(testdir)/test_ccsm3.f90 libcoordinates.a -L. $(LFLAGS) $(coord_libs)
	@echo " "
	@echo "    test_ccsm3.x is ready."
	@echo " "

test_etopo: coord-static
	$(FC) $(DFLAGS) $(FFLAGS) -o test_etopo.x $(testdir)/test_etopo.f90 libcoordinates.a -L. $(LFLAGS) $(coord_libs)
	@echo " "
	@echo "    test_etopo.x is ready."
	@echo " "

test_MAR: coord-static
	$(FC) $(DFLAGS) $(FFLAGS) -o test_MAR.x $(testdir)/test_MAR.f90 libcoordinates.a -L. $(LFLAGS) $(coord_libs)
	@echo " "
	@echo "    test_MAR.x is ready."
	@echo " "

test_subset: coord0-shared
	$(FC) $(DFLAGS) $(FFLAGS) -o test_subset.x $(testdir)/test_subset.f90 -L. -lcoordinates0 $(LFLAGS) $(coord_libs)
	@echo " "
	@echo "    test_subset.x is ready."
	@echo " "

test_subset2: coord-shared
	$(FC) $(DFLAGS) $(FFLAGS) -o test_subset2.x $(testdir)/test_subset2.f90 -L. -lcoordinates $(LFLAGS) $(coord_libs)
	@echo " "
	@echo "    test_subset2.x is ready."
	@echo " "

test_multigrid: coord-shared
	$(FC) $(DFLAGS) $(FFLAGS) -o test_multigrid.x $(testdir)/test_multigrid.f90 -L. -lcoordinates $(LFLAGS) $(coord_libs)
	@echo " "
	@echo "    test_multigrid.x is ready."
	@echo " "

test_proj: coord-static
	$(FC) $(DFLAGS) $(FFLAGS) -o test_proj.x $(testdir)/test_proj.f90 libcoordinates.a -L. $(LFLAGS) $(coord_libs)
	@echo " "
	@echo "    test_proj.x is ready."
	@echo " "

test_proj_etopo1: coord-static
	$(FC) $(DFLAGS) $(FFLAGS) -o test_proj_etopo1.x $(testdir)/test_proj_etopo1.f90 libcoordinates.a -L. $(LFLAGS) $(coord_libs)
	@echo " "
	@echo "    test_proj_etopo1.x is ready."
	@echo " "

test_interp: coord-static
	$(FC) $(DFLAGS) $(FFLAGS) -o test_interp.x $(testdir)/test_interp.f90 libcoordinates.a -L. $(LFLAGS) $(coord_libs)
	@echo " "
	@echo "    test_interp.x is ready."
	@echo " "

test_climber: coord-static
	$(FC) $(DFLAGS) $(FFLAGS) -o test_climber.x $(testdir)/test_climber.f90 libcoordinates.a -L. $(LFLAGS) $(coord_libs)
	@echo " "
	@echo "    test_climber.x is ready."
	@echo " "

test_ccsm3diff: coord-static
	$(FC) $(DFLAGS) $(FFLAGS) -o test_ccsm3_diffusion.x $(testdir)/test_ccsm3_diffusion.f90 libcoordinates.a -L. $(LFLAGS) $(coord_libs)
	@echo " "
	@echo "    test_ccsm3_diffusion.x is ready."
	@echo " "

test_loess: $(objdir)/ncio.o $(objdir)/interp1D.o $(objdir)/index.o $(objdir)/loess.o 
	$(FC) $(DFLAGS) $(FFLAGS) -o test_loess.x $^ $(testdir)/test_loess.f90 $(LFLAGS)
	@echo " "
...
test_nat: extra/tile/t4gen.f extra/tile/t4man.f extra/tile/t4int.f \
	...
	$(FC) $(DFLAGS) $(FFLAGS) -o test_nat.x $^ $(testdir)/test_nat.f90
	@echo " "
...
test_nat_new: extra/tile/t4gen.f extra/tile/t4man.f extra/tile/t4int.f \
			  extra/tile/t4que.f extra/tile/t4int.f90
	$(FC) $(DFLAGS) $(FFLAGS) -o test_nat_new.x $^ $(testdir)/test_nat_new.f90
	@echo " "
...
test_geodinverse: $(objdir)/planet.o $(objdir)/geodesic.o
	$(FC) $(DFLAGS) $(FFLAGS) -o test_geodinverse.x $^ $(testdir)/test_geodinverse.f90
	@echo " "
...
test_pointpoly: $(objdir)/polygons.o
	$(FC) $(DFLAGS) $(FFLAGS) -o test_pointpoly.x $^ $(testdir)/test_pointpoly.f90 $(LFLAGS)
	@echo " "
...
test_polygon: $(objdir)/polygons.o $(objdir)/index.o
	$(FC) $(DFLAGS) $(FFLAGS) -o test_polygon.x $^ $(testdir)/test_polygon.f90 $(LFLAGS)
	@echo " "
